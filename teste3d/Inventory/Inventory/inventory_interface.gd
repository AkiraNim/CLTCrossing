...
@onready var player_inventory: PanelContainer = $PlayerInventory/PlayerInventory
@onready var equip_inventory: PanelContainer = $PlayerInventory/EquipInventory
@onready var external_inventory: PanelContainer = $ExternalInventory/ExternalInventory
